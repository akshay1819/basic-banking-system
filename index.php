...
<body>
    <section id="one">
        ...
        <div class="data">
            <div class="data-text">
                <h1>Transfer money in simple & secure steps</h1>
    ...
    <section id="two">
        <div class="small " style="background-image: linear-gradient( 68.3deg,  rgba(245,177,97,1) 0.4%, rgba(236,54,110,1) 100.2% );">
            <div class="row">
                <div class="col col-img">
                    <img src="images/f1.jpg" alt="figure" class="image" />
                </div>
                <div class="col">
            ...
            <div class="row row-two">
                ...
                <div class="col">
                    <img src="images/f2.jpg" alt="figure" class="image" />
                </div>
            </div>

            <div class="row row-three">
                <div class="col">
                    <img src="images/f3.jpeg" alt="figure" class="image" />
                </div>
                <div class="col">
                    <h1 class="cust-head">Transaction History</h1>
                    <p class="cust-para">
                        The Banking sector has seen a lot of transaction.<br />
